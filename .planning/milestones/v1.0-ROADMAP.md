...
Plans:
- [ ] 03-01-PLAN.md — Pigeon bridge definition, code generation, Dart adapter with error mapping, stub platform, plugin registration
- [ ] 03-02-PLAN.md — iOS/Darwin Swift bridge using ASAuthorizationController
- [ ] 03-03-PLAN.md — Android Kotlin bridge using CredentialManager
- [ ] 03-04-PLAN.md — Web Dart bridge using package:web JS interop with conditional imports
...
Plans:
- [ ] 04-01-PLAN.md — Windows FFI bridge (webauthn.dll bindings + WindowsWebAuthnPlatform)
- [ ] 04-02-PLAN.md — Linux FFI bridge (libfido2 bindings + LinuxWebAuthnPlatform)
- [ ] 04-03-PLAN.md — macOS enablement + all-platform registration wiring + podspec/pubspec updates
...
Plans:
- [ ] 05-00-PLAN.md — Wave 0 test infrastructure: mock_webauthn.dart + 4 test stub files
- [ ] 05-01-PLAN.md — Public API surface: AuthWebAuthnCredential model, AuthPluginInterface stubs, AuthCategory forwarding, AuthCategoryMethod enum
- [ ] 05-02-PLAN.md — Cognito implementation: CognitoWebAuthnCredential model, 4 method overrides in AmplifyAuthCognitoDart, test implementations
...
Plans:
- [ ] 06-01-PLAN.md — Foundation: AuthenticatorStep enums, AuthState subclasses, PasswordlessSettings model, localization strings
- [ ] 06-02-PLAN.md — Challenge selection screen (UI-01), passkey ceremony flow (UI-02), error display wiring (UI-04)
- [ ] 06-03-PLAN.md — Passkey registration prompt (UI-03), bloc credential management events, error messaging (UI-04)
...
| FLOW-04 | 1 |
| FLOW-05 | 1 |
| PLAT-01 | 3 | 4/4 | Complete   | 2026-03-09 |
| PLAT-03 | 4 |
| PLAT-04 | 3 |
| PLAT-05 | 4 |
| PLAT-06 | 4 |
| PLAT-07 | 1 |
| PLAT-08 | 3, 4 |
| UI-01 | 6 | 3/3 | Complete   | 2026-03-10 |
| UI-03 | 6 |
| UI-04 | 6 |
